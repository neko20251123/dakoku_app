...
<div class="mx-auto max-w-5xl p-6 space-y-6">
    ...
    <div class="rounded-2xl border bg-white shadow-sm">
        ...
        <form
            id="timecalc-form"
            method="POST"
            action="{{ route('timecalc.calculateJson') }}"
            class="p-5 space-y-4"
        >
            @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <div class="mt-1 flex items-center gap-2">
                                    <select
                                        name="rows_ui[{{ $i }}][start_h]"
                                        data-time-select
                                        class="w-24 rounded-lg border-slate-200 bg-white px-2 py-2 text-sm"
                                    >
                                        <option value="">--</option>
                                        @for ($h = 0; $h <= 23; $h++)
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="rounded-xl border bg-blue-50 p-4">
                ...
                <div class="text-3xl font-extrabold text-blue-900">
                    ...
                    <span class="text-base font-semibold text-blue-800 ml-1">h</span>
                </div>

                {{-- ひとこと（JS制御） --}}
                <div
                    id="toast-message"
                    class="mt-3 hidden rounded-lg border border-blue-200 bg-white/70 px-3 py-2 text-sm text-slate-800"
                ></div>
        ...
        <div data-row class="rounded-xl border bg-slate-50 p-4">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                ...
                <div class="md:col-span-3">
                    ...
                    <div class="mt-1 flex items-center gap-2">
                        <select
                            name="rows_ui[__INDEX__][start_h]"
                            data-time-select
                            class="w-24 rounded-lg border-slate-200 bg-white px-2 py-2 text-sm"
                        >
                            <option value="">--</option>
                        ...
                        <span class="text-slate-400">:</span>
                        <select
                            name="rows_ui[__INDEX__][start_m]"
                            data-time-select
                            class="w-24 rounded-lg border-slate-200 bg-white px-2 py-2 text-sm"
                        >
                            <option value="">--</option>
